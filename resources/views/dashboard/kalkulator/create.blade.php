...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Tambah Fitur Kalkulator</h1>
    <p class="text-slate-500 mt-1">Tambahkan fitur atau layanan baru yang dapat dipilih klien pada halaman kalkulator.</p>
</div>
...
<div class="max-w-3xl bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    ...
    <div class="bg-slate-50 px-8 py-5 border-b border-slate-100 flex items-center">
        ...
        <h2 class="text-lg font-bold text-slate-700">Form Informasi Fitur</h2>
    </div>

    <form action="{{ route('dashboard.calculator-features.store') }}" method="POST" class="p-8">
        @csrf
        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div>
                    ...
                    <p class="text-xs font-medium text-slate-500 mt-2 flex items-start"><i data-lucide="info" class="w-3.5 h-3.5 mr-1 flex-shrink-0"></i> Nama yang ditampilkan.</p>
                </div>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors"
                    placeholder="Deskripsi singkat fitur ini..."></textarea>
            </div>
